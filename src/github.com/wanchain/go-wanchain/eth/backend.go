...
import (
	...
	istanbulBackend "github.com/wanchain/go-wanchain/consensus/istanbul/backend"
...
func New(ctx *node.ServiceContext, config *Config) (*Ethereum, error) {
	...
	eth.ApiBackend = &EthApiBackend{eth, nil}	//设置eth的api backend.
...
func (s *Ethereum) BlockChain() *core.BlockChain       { return s.blockchain }	//访问区块链的方法集合.
